...
const ProjectActions = ({
  ...
  return <>
        ...
        <div className="relative z-[100]">
          ...
          if (onStatusChange) {
            ...
            <SelectContent className="z-[100] bg-white" position="popper">
              {PROJECT_STATUSES.map(statusOption => <SelectItem key={statusOption.value} value={statusOption.value} className="capitalize cursor-pointer" style={{
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 flex items-center gap-2 z-10">
        ...
        {onClose && <Button onClick={onClose} className="w-[130px] shadow-lg bg-black text-white hover:bg-gray-800">
            Done
          </Button>}
      </div>
    </>;
